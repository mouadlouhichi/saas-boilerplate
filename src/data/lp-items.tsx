export const LP_GRID_ITEMS = [
  ...
  {
    title: "Storybook",
    description: "Create, test, and showcase your AllComponentsStore.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  {
    title: "Radix UI",
    description: "Headless UI AllComponentsStore for endless customization.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  {
    title: "AllComponentsStore coupling & cohesion graph",
